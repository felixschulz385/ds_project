...
```{r echo=FALSE, out.width='60%', fig.cap="Tasks in Computer Vision"}
knitr::include_graphics(here::here('presentations/fig/tasks_comp_vision'))
```

\begin{tiny}
Figure credit: Taspinar, A. (2017, Dec 4) Using Convolutional Neural Networks to detect features in satellite images. https://ataspinar.com/2017/12/04/using-convolutional-neural-networks-to-detect-features-in-sattelite-images/
\end{tiny}

# Data analysis: Neural Networks

```{r echo=FALSE, out.width='60%', fig.cap="Segmentation: Pixel-Level Image Classification"}
knitr::include_graphics(here::here('presentations/fig/segmentation'))
```

\begin{tiny}
Figure credit: Choi, U. (2021, March 19) Semantic Segmentation (FCN, U-Net, DeepLab V3+). https://wooono.tistory.com/267
\end{tiny}
...
\begin{tiny}
Figure credit:
Wambugu, N., Chen, Y., Xiao, Z., Wei, M., Bello, S. A., Junior, J. M., & Li, J. (2021). A hybrid deep convolutional neural network for accurate land cover classification. International Journal of Applied Earth Observation and Geoinformation, 103, 102515. https://doi.org/10.1016/j.jag.2021.102515.
\end{tiny}
