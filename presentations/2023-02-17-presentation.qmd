...
![The economic model used for the evaluation of turnoffs](fig/economic_model.png)
...
::: {#fig-turnoff-example layout-ncol=5}
...
::: {#fig-turnoff-example layout-ncol=2}
...
![The height model of a selected driveway. The standard deviation of the slope is 4.68, the rating therefore 0.95 (© GeoBasis-DE/LGB)](fig/BB_ML_0104_14.png)
...
## Training data - LoveDA (Nanjing, Changzhou and Wuhan / China)
