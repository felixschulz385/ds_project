...
\item Since one of our goals is to provide a user-friendly alternative to expert reports, we are kindly asking whether we are allowed to use German for our online application. Otherwise, there is again a language barrier for German citizens and only highly educated people receive adequate access to our results.
\end{enumerate}
