...
content = html.Div([
    dmc.Tabs([
        dmc.TabsList([
            ...
            dmc.Tab("Informationen", value = "interviews"),
    ...
    dmc.TabsPanel(
        ...
        # start accordion #2
            dmc.AccordionItem([
                dmc.AccordionControl("Hindernisse Ohren"),
                dmc.AccordionPanel(
                    dcc.Markdown('''
    ...
    dmc.TabsPanel(
        ...
        # Sunburst Plot
        dbc.Row([dbc.Col([
            dcc.Graph(figure = Ohren_sunburst, responsive=True, style = {'height': '85vh', 'width': '85vh'})
